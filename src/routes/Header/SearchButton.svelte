...
<button
  ...
  p-3 gap-3 rounded-xl bg-sky-100 backdrop-blur-xl text-sm text-white cursor-text`}
  on:click={() => (searchFocus = true)}
>
  <svg
    width="20"
    height="20"
    ...
    /></svg
  >
  <p class="opacity-50">Astronauts</p>
</button>
